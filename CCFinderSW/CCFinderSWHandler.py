...
def analyze(engine_name, extension):
    # データセットのフォルダパス
    datasets_folder_path = PathManager.get_path(engine_name, PathData.PROGRAM_FOLDER_NAME)
    ...
    for dataset in os.listdir(datasets_folder_path):
        ...
        # 解析結果を保存
        result_folder = PathManager.get_path(engine_name, PathData.CCFINDERSW_RESULT_FOLDER_NAME)
